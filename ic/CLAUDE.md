...
See `.env.example` for all environment variables. LLM backends (`lunarwing_cloud`, `openai`, `anthropic`, `ollama`, `openai_compatible`, `tinfoil`, `bedrock`) documented in `src/llm/CLAUDE.md`.
