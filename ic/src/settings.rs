...
pub struct Settings {
    ...
    /// `seeded_default_permission`.  Absent tools fall back to the seeded default, or
    /// `AskEachTime` if the tool is unknown.
    #[serde(default)]
    pub tool_permissions: HashMap<String, crate::tools::permissions::PermissionState>,
}
...
pub struct ChannelSettings {
    ...
    /// XMPP JID (enables XMPP channel when set).
    #[serde(default)]
    pub xmpp_jid: Option<String>,
    /// XMPP password.
    #[serde(default)]
    pub xmpp_password: Option<String>,
    /// XMPP allowed senders (comma-separated bare JIDs or `*`).
    #[serde(default)]
    pub xmpp_allow_from: Option<String>,
    /// XMPP DM policy: "allowlist", "open", or "pairing". Default: "allowlist".
    #[serde(default)]
    pub xmpp_dm_policy: Option<String>,
    /// XMPP allowed MUC rooms (comma-separated room JIDs or `*`).
    #[serde(default)]
    pub xmpp_allow_rooms: Option<String>,
    /// XMPP MUC rooms that must use encrypted groupchat handling (comma-separated room JIDs).
    #[serde(default)]
    pub xmpp_encrypted_rooms: Option<String>,
    /// XMPP OMEMO store directory.
    #[serde(default)]
    pub xmpp_omemo_store_dir: Option<std::path::PathBuf>,
    /// Whether to allow plaintext fallback when OMEMO is unavailable.
    #[serde(default)]
    pub xmpp_allow_plaintext_fallback: Option<bool>,
...
impl Default for ChannelSettings {
    fn default() -> Self {
        Self {
            ...
            xmpp_jid: None,
            xmpp_password: None,
            xmpp_allow_from: None,
            xmpp_dm_policy: None,
            xmpp_allow_rooms: None,
            xmpp_encrypted_rooms: None,
            xmpp_omemo_store_dir: None,
