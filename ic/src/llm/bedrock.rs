...
/// Convert LunarWing `ChatMessage` list into Bedrock system blocks + messages.
///
...
/// Build Bedrock `ToolConfiguration` from LunarWing tool definitions.
...
/// Map Bedrock `StopReason` to LunarWing `FinishReason`.
