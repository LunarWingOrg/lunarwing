...
pub use document::{
    DocumentVersion, IDENTITY_PATHS, MemoryChunk, MemoryDocument, VersionSummary, WorkspaceEntry,
    is_identity_path, merge_workspace_entries, paths,
};
