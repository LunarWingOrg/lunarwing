...
fn routine_request_discovery_schema() -> Value {
    serde_json::json!({
        ...
        "examples": [
            ...
            { "kind": "system_event", "source": "github", "event_type": "issue.opened", "filters": { "repository": "LunarWingOrg/lunarwing" } }
        ]
    })
}
    ...
    vec![
        ...
        serde_json::json!({
            ...
            "request": {
                ...
                "filters": { "repository": "LunarWingOrg/lunarwing" }
            },
            "execution": {
                "mode": "full_job"
            }
    ...
    fn parses_grouped_system_event_request() {
        ...
        assert!(
            matches!(
                ...
                if source == "github"
                    && event_type == "issue.opened"
                    && filters.get("repository") == Some(&"LunarWingOrg/lunarwing".to_string())
