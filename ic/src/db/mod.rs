...
async fn validate_postgres(pool: &deadpool_postgres::Pool) -> Result<(), DatabaseError> {
    ...
    if major_version < MIN_PG_MAJOR_VERSION {
        return Err(DatabaseError::Pool(format!(
            "PostgreSQL {} detected. LunarWing requires PostgreSQL {} or later \
...
pub trait WorkspaceStore: Send + Sync {
    ...
    ) -> Result<i32, crate::error::WorkspaceError>;
    ...
    async fn get_version(
        ...
        document_id: Uuid,
        version: i32,
    ) -> Result<crate::workspace::DocumentVersion, crate::error::WorkspaceError>;
    ...
    async fn list_versions(
        ...
        document_id: Uuid,
        limit: i64,
    ) -> Result<Vec<crate::workspace::VersionSummary>, crate::error::WorkspaceError>;
    ...
    async fn get_latest_version_number(
        &self,
        document_id: Uuid,
    ) -> Result<Option<i32>, crate::error::WorkspaceError>;
    ...
    async fn prune_versions(
        ...
        document_id: Uuid,
        keep_count: i32,
    ) -> Result<u64, crate::error::WorkspaceError>;
