...
async def test_oauth_credential_injection_after_gmail_auth(lunarwing_server):
...
async def test_tool_registry_lists_authenticated_extensions(lunarwing_server):
...
async def test_credential_fallback_documented_in_code(lunarwing_server):
