...
async def test_routine_with_oauth_credentials_e2e(page, lunarwing_server):
...
async def test_routine_list_shows_oauth_tools_available(page, lunarwing_server):
...
async def test_oauth_token_accessible_across_execution_contexts(lunarwing_server):
