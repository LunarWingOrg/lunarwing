use lunarwing::llm::ChatMessage;
use lunarwing::llm::gemini_oauth::GeminiOauthProvider;
...
fn test_regression_chat_message_helpers() {
    ...
    assert_eq!(user_msg.role, lunarwing::llm::Role::User);
    assert_eq!(user_msg.content, "hello");

    let system_msg = ChatMessage::system("you are helpful");
    assert_eq!(system_msg.role, lunarwing::llm::Role::System);
