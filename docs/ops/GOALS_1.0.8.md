...
9. [ ] Character Lorebooks and profile enhancements. Profile onboarding already added in previous release but adding this to testing suite would be appreciated.
10. [ ] Enhance automated testing scripts. number 11 is related to this.
11. [ ] need a full extensive test using my testing_guide and other testing scripts
12. [ ] Complete tests of everything that was changed since 1.0.6
13. [ ] Write up release notes for v1.0.7 explaining all changes since v1.0.6
14. [ ] Create a new branch to correspond with release
15. [ ] Create GH release tag and add release notes to it like other releases already have
