...
8. [ ] Update ROADMAP file to reflect accuracy
...
11. [ ] Finalize goals list
12. [x] Bump crate versions to 1.1.6
13. [ ] Run all cargo tests
14. [ ] Fix remaining broken cargo tests and document any which are still not working correctly. New ones must also be made
...
19. [ ] Write up release notes (at root of repo) for v1.1.6 explaining all changes since v1.1.5 as well as accurate known issues list
20. [ ] Update release notes (at root of repo) with any minor known issues that may not be fully resolved (after #19)
21. [ ] Create new branch to correspond with release
22. [ ] Create GH release tag and add release notes to it like other releases already have
