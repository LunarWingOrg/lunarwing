...
2. [ ] Prepare fully detailed report detailing all remaining nearai/near/ironclaw/nearcloud/nearagent/near::agent/telegram references in the source code and documentation. put it in docs/internal as a new markdown document
