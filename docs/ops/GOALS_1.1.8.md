...
8. [ ] Add new external worker, opencode. Plan it out first and investigate if Paseo integration is also viable. My OC Paseo Ansible Playbook would be worth inspecting for something like this!
