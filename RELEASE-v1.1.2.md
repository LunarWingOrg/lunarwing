...
- **Remove remaining non-supported extensions (Google-related)** — Continue the proprietary/non-aligned extension cleanup; the GitHub extension decision remains deferred (currently targeted v1.1.9).
